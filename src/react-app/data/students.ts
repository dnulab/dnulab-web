...
export const studentTerms: StudentTerm[] = [
  {
    ...
    students: [
      ...
      },
      {
        name: "Zachary Deitch",
        graduationYear: "'27",
        projectTitle: "Discovering latent factors in financial models via LLMs",
      },
      {
        name: "Adacus Greene",
        graduationYear: "'27",
      ...
      },
      {
        name: "Biruk Kebede",
        graduationYear: "'29",
        projectTitle: "Transformer Error Correction",
        advisors: ["John MacCormick"],
      },
      {
        name: "John Lee",
      ...
      },
      {
        ...
        graduationYear: "'28",
        projectTitle:
          "Incorporating frozen components in neural network architectures",
        advisors: ["John MacCormick"],
      },
    ],
  },
  {
    ...
    advisors: ["Matt Ferland", "William Goble", "John MacCormick"],
    students: [
      {
        name: "Pranav Azad",
        graduationYear: "'27",
